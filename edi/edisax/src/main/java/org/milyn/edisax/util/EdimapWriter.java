...
public class EdimapWriter {
    ...
    private static final String NS = EDIConfigDigester.DEFAULT_XSD;
    ...
    private void addFields(List<Field> fields, Element segmentEl) {
        for(Field field : fields) {
            ...
            mapBeanProperties(field, fieldEl, "name", "xmltag", "nodeTypeRef", "truncatable", "maxLength", "minLength", "required", "dataType", "modifiable","defaultValue", "dataTypeParametersString|dataTypeParameters");
    ...
    private void addComponents(List<Component> components, Element fieldEl) {
        for(Component component : components) {
            ...
            mapBeanProperties(component, componentEl, "name", "xmltag", "nodeTypeRef", "truncatable", "maxLength", "minLength", "required", "dataType",  "modifiable","defaultValue", "dataTypeParametersString|dataTypeParameters");
